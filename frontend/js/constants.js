...
const welcome_p = 'Crypto4Bies is a decentralized, open-source project that aims to bring the 4wd community together, and clean up our beautiful contry in the process.';
...
const p_public_mint = "Crypto4bies are open for mint. See you soon cowboys!";
...
const button_public_mint = "Mint Your Crypto4Bie Here.";
const mint_failed = "Minting failed. Manually Refresh the Transaction in Metamask.";
